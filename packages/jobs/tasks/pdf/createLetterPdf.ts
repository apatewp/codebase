const createLetterPdf = async (payload, helpers) => {
  ...
  // const { mdx, tableName, id, letterTemplate } = payload;
  // const timestamp = new Date().toISOString();
  // const bucketName = process.env.BUCKET_NAME;
  // const filename = `${bucketName}/${tableName}/${id}/` +
  //   `${timestamp}-${letterTemplate}.pdf`;
